...
WHERE utilizador_has_topico.utilizador_id_utilizador = ? AND  utilizador_has_topico.topico_id_topico = ?";
            ...
            if ($contador_temp == 0) {
                $query1 = "INSERT INTO utilizador_has_topico (utilizador_has_topico.utilizador_id_utilizador, utilizador_has_topico.topico_id_topico,utilizador_has_topico.votos_id_votos) VALUES(?,?,2)";
            } else {
            ...
            if (mysqli_stmt_prepare($stmt1, $query1)) {
                ...
                } else if ($z == 2 AND $contador_temp != 0) {
                    $voto = 1;
